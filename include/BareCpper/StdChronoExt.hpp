/** Enable use of Monotonic (i.e.e Realtime-Counter [RTC]) as the clock source of the std::chrono::steady_clock and std::chrono::system_clock
...
int gettimeofday(struct timeval* tv, void* tz) {
	auto timeNow = BareCpper::Monotonic::now().time_since_epoch();
